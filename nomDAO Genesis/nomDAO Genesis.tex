...
\begin{sciabstract}
  This hop-paper serves as a whitepaper for {\it nomDAO\/} (nom token), and describe the vision of the ecosystem. 
  nomDAO is presented as a new form of DAO, metaDAO, based on liquid democracy with the capacity to run a decentralized exchange.
